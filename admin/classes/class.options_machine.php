...
class Options_Machine {
    ...
    function __construct($options, $type) {
        ...
        $return = $this->optionsframework_machine($options, $type);
            ...
            switch ($value['type']) {
                ...
                case 'background':
                    ...
                    if (isset($background['position'])) {
                        ...
                        $positions = array('left top' => 'Left Top',
    ...
    public static function optionsframework_ads_function($id, $std, $oldorder, $order, $int) {
        ...
        $slider .= '<input class="slide of-input of-slider-title" name="' . $id . '[' . $order . '][position]" id="' . $id . '_' . $order . '_slide_position" value="' . stripslashes($val['position']) . '" />';
        ...
        $slider .= '<input class="slide of-input of-slider-featured" name="' . $id . '[' . $order . '][width]" id="' . $id . '_' . $order . '_slide_width" value="' . stripslashes($val['width']) . '" />';
